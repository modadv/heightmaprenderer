...
// E:\Projects\review-bgfx\bgfx\.build\win64_vs2022\bin\shadercDebug.exe -f .\fs_terrain_render_normal.sc -o E:\Projects\review-bgfx\bgfx\examples\runtime\shaders\dx11\fs_terrain_render_normal.bin --type f --platform windows -p ps_5_0 -i E:\Projects\review-bgfx\bgfx\src --debug -O 0
...
float3 n = normalize(float3(-s, 1));
bgfx_FragData0 = float4(abs(n), 1);
}
