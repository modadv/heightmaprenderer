...
// E:\Projects\review-bgfx\bgfx\.build\win64_vs2022\bin\shadercDebug.exe -f vs_terrain_render.sc -o E:\Projects\review-bgfx\bgfx\examples\runtime\shaders\dx11\vs_terrain_render.bin --type vertex --platform windows -p vs_5_0 -i E:\Projects\review-bgfx\bgfx\src --debug -O 0
...
float2 uv_frag;
uv_frag.x = (finalVertex.x + u_aspectParams.x) / (2.0 * u_aspectParams.x);
uv_frag.y = (finalVertex.y + u_aspectParams.y) / (2.0 * u_aspectParams.y);
_varying_.v_texcoord0 = uv_frag;
